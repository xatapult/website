...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:local="#local.jsx_yjb_kz" version="1.0"
  ...
  <p:documentation>
    Main XProc pipeline for creating the different versions of the Xatapult website.
  </p:documentation>

  <!-- ================================================================== -->
  <!-- SETUP: -->

  <p:option name="href-specification" required="false" select="resolve-uri('../source/website-xatapult-specification.xml', static-base-uri())">
